...
export default function Deadline() {
    ...
    return (
        <div className={classes.root}>
            <Box display='flex' alignItems='center' justifyContent='space-between'  className={classes.actionsBox}>
                <Typography className={classes.titleStyle}>마감 시간</Typography>
                <FormControlLabel control={<Checkbox icon={<UnCheckedIcon />} checkedIcon={<CheckedIcon />} value="essential" color="primary"/>} label="시간 제한 없음" />
            </Box>
            ...
            <FormControl component="div" style={{marginTop:10, marginLeft: 16}}>
