            ...
            <div className={classes.root}>
                <Box className={classes.positionToolTip}>
                    <Box display='flex' alignItems='center' className={classes.titleBox}>
                        <Typography className={classes.titleText}>강의 현황</Typography>
                ...
                <Box display='flex' justifyContent='space-between'>
                    <Box className={classes.box}>
                        <Typography className={classes.boxTitle}>개설 강의실</Typography>
                        <Typography className={classes.boxNumber}>5</Typography>
                    </Box>
                    <Box className={classes.box}>
                        <Typography className={classes.boxTitle}>개설 강의</Typography>
                        <Typography className={classes.boxNumber}>47</Typography>
                    </Box>
                    <Box className={classes.box}>
                        <Typography className={classes.boxTitle}>전체 수강생</Typography>
                        <Typography className={classes.boxNumber}>64</Typography>
                    </Box>
                    <Box className={classes.box}>
                        <Typography className={classes.boxTitle}>활성 수강생</Typography>
