            ...
            <div className={classes.root}>
                ...
                >
                    <Box display='flex' justifyContent='space-between' alignItems='center' className={classes.titleBox}>
                        <Typography className={classes.titleText}>수강 완료</Typography>
                    ...
                    <DialogContent style={{marginBottom:20}}>
                        <Typography variant='body1' className={classes.errorTxt}>수강완료 전 꼭 확인하세요.</Typography>
                        <DialogContentText>
                            수강을 완료하면,
                        </DialogContentText>
                        <ul className={classes.contentList}>
                            <li>'평가, 과제' 유형 제출이 더이상 불가</li>
                            <li>'화상 수업' 참여 불가</li>
