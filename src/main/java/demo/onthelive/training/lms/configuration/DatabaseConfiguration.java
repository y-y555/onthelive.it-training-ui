...
import demo.onthelive.training.lms.configuration.support.DatabaseProperties;
...
@MapperScan(value = "demo.onthelive.training.lms.repository.mapper")
public class DatabaseConfiguration {
    ...
    private final SystemEnvUtil systemEnvUtil;
