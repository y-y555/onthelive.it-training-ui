                    ...
                    <Box display='flex' flexDirection='column'>
                        <FormControl>
                            ...
                            >
                                ...
                                <MenuItem value={""} className={classes.menuText}>강의실 선택</MenuItem>
                                <MenuItem value={"강의실 이름1"} className={classes.menuText}>강의실 이름1</MenuItem>
                                <MenuItem value={"강의실 이름2"} className={classes.menuText}>강의실 이름2</MenuItem>
                                <MenuItem value={"강의실 이름3"} className={classes.menuText}>강의실 이름3</MenuItem>
                            </Select>
                        </FormControl>
